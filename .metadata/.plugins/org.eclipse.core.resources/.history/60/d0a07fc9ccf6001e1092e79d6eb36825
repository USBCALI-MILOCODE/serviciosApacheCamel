...
public class ErrorDetail {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.code, errorDetail.code) && Objects.equals(this.detail, errorDetail.detail)
				&& Objects.equals(this.id, errorDetail.id) && Objects.equals(this.source, errorDetail.source)
				&& Objects.equals(this.status, errorDetail.status) && Objects.equals(this.title, errorDetail.title);
	}
